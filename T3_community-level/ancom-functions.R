...
ANCOM = function(feature_table, meta_data, struc_zero = NULL, main_var, p_adj_method = "BH",
  ...
  #ATTENTION: I modified the clr function because it was outputing all infinite and NA values
  clr_table = apply(feature_table, 2, function(x) {clr(x + min(feature_table[feature_table!=0])/2)})
