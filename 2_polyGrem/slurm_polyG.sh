...
DATADIR=SNIC_PROJECT/JAELLE/DENTAL_CALCULUS_SECONDSCREEN_190219/
...
DATADIR=SNIC_PROJECT/calculus/DC3/P1_demux_211001/
...
DATADIR=SNIC_PROJECT/GORILLA_METAGENOMES/pairedend/paired_fastq #incomplete path: there are directories paired_fastq2 and paired_fastq3
