...
#Load FastANI output
ANItable <- read.table("/proj/sllstore2017021/nobackup/MARKELLA/H2_haplotype_network/fastani_output.txt", sep="\t", dec=".")
...
write.table(maxANItable, file="/proj/sllstore2017021/nobackup/MARKELLA/H2_haplotype_network/fastani_output_maxANI.txt", 
