...
# Adapted from SNIC_PROJECT/JAELLE/DENTAL_CALCULUS_SECONDSCREEN_190219/SCRIPTS/rmdup_merged_190606.sh
...
rmdup_script=SNIC_PROJECT/EXAMPLES_for_new_users/remove_duplicates_single_end.py
