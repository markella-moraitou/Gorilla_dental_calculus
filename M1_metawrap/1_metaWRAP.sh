...
# conda activate SNIC_PROJECT/ADRIAN/bin/bmtagger-env
...
checkm data setRoot SNIC_PROJECT/SHARED_REFERENCES/CHECKM/2015_01_16
...
INTERLEAVED=RD2_mapping/decontam_files
BASEDIR=SNIC_PROJECT/ADRIAN/calculus/Gorilla/mag/metaWRAP/full-decontam-set
mkdir -p $BASEDIR

# generate a list of MAGs for the species of interest
# MAGLIST=$(grep $SSPECIES M4_MAGtaxonomy/classify/hq.bac120.summary.tsv | awk '{print $1}' | cut -d . -f 1 )

### bin/ DIR for metaWRAP
SOFT=SNIC_PROJECT/ADRIAN/bin/metaWRAP/bin/metawrap-scripts
